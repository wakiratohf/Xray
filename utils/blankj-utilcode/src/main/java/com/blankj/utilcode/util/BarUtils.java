...
public final class BarUtils {
    ...
    public static int getStatusBarHeight() {
        ...
        @SuppressLint("InternalInsetResource") int resourceId = resources.getIdentifier("status_bar_height", "dimen", "android");
    ...
    public static int getNavBarHeight() {
        ...
        @SuppressLint("DiscouragedApi") int resourceId = res.getIdentifier("navigation_bar_height", "dimen", "android");
        if (resourceId != 0) {
    ...
    public static boolean isNavBarVisible(@NonNull final Window window) {
        ...
        if (isVisible) {
            ...
            if (UtilsBridge.isSamsung() && Build.VERSION.SDK_INT < Build.VERSION_CODES.Q) {
                try {
